...
我发相刚刚有个工作流有点问题 我让research assistant agent干活 它 @server/research/ 怎么放到这里来了 不应该都放到 @missions 吗

### Prompt 43

我觉得我们的agent team要有一个不同的架构 应该是hirechcy的架构！ 在agents 界面显示也应该这样！ 上层管下层团队 团队领导管团队成员 团队之间可以相互给task 和 context合作！ 你觉得如何呢 我们现在只plan不写代码
